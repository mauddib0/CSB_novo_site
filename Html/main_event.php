...
<head>
    ...
    <!-- SEO -->
    <meta name="description" content="Центр Підтримки Бізнесу NOVO — допомога підприємцям, консультації, ресурси для розвитку малого і середнього бізнесу." />
    <meta name="keywords" content="підприємництво, підтримка бізнесу, ЦПБ, консультації, стартапи, бізнес Україна, як відкрити бізнес" />
    <meta name="author" content="Predko Viktor" />
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="../Assets/icon/logo.png">
    <!-- Title -->
    <title>Центр Підтримки Бізнесу NOVO</title>
    <!-- Шрифти -->
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="../Css/main_event.css" />
    <!-- Glide.js CSS -->
...
<body>
    ...
    <div class="container">
        ...
        <header id="header">
            ...
            <a href="event.html" class="drop_burger">Назад</a> </div>
        </header>
        <h1>Новини Та Події Від ЦПБ <span>NOVO</span></h1>
        <a href="event.php">
            <h3 class="home_link">Назад</h3> </a>
        <!--        main_event!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
    ...
    <div class="main_event_info">
        ...
        <h2 class="main_event_title">
            <?= htmlspecialchars($mainEvent['title']) ?>
        </h2>

        <div class="main_event_location">
            <div class="main_event_start_time">
                <div id="main_event_date"><?= htmlspecialchars($mainEvent['date']) ?></div>
                <div id="main_event_time"><?= htmlspecialchars($mainEvent['time']) ?></div>
            </div>

            <div class="main_event_share_social">
    ...
    <!-- Фото -->
    <img 
        src="data:<?= htmlspecialchars($mime_type) ?>;base64,<?= base64_encode($mainEvent['image']) ?>" 
        alt="Головна подія" 
        class="main_event_img"
    >

    <!-- Опис події -->
    <p class="main_event_about">
        <?= nl2br(htmlspecialchars($mainEvent['description'])) ?>

        <?php if (!empty($mainEvent['reg_link'])): ?>
            <br><br>
            <a class="google_link" href="<?= htmlspecialchars($mainEvent['reg_link']) ?>" target="_blank">форма реєстрації</a>
        <?php endif; ?>
    </p>
</section>
	...
	c-5.858,5.857-5.858,15.355,0,21.213L278.787,150H15c-8.284,0-15,6.716-15,15S6.716,180,15,180z" /> </svg></a>
                        </div>
